...
Deterministic rules and behavior.

severe compounding errors when decomposing the
whole system into lots of smaller-scale but interpretable
modules, as the perception uncertainty and modeling errors
would snowball through the pipeline.
...
Entire pipeline is treated as a single learned task
