...
Initially, Swadiryus \cite{swadiryus_DifferentiableMotionPlanning_2025} developed a trajectory sampling planner, which generates a series of time horizon trajectories and scores them based on a cost function.
...
Henceforth, this thesis aims at enabling on-board computation of the entire DiffPlan stack and independent deployment of the self-driving car.
...
A series of experiments will be conducted to measure the speedup of the associated optimized algorithms and, benchmark and compare the two differentiable local motion planners: Temporal sampler DiffPlan and the spatial sampler DiffSpatialPlan. 

%* modify this later when layout is more clear
%! modify this at the end
Part \ref{part:stateoftheart} presents the literature review of past and current methods of autonomous vehicle systems in Section \ref{chapter:AutonomousDrivingSystems}.
