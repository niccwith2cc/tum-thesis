...
% My breakdown of the paper so far is this:
% \begin{enumerate}
%   \item Discuss the improvements to the temporal sampling planner
%   \item Include graphical analysis of laptop and desktop
%   \item Discuss denser sampling analysis (speed up graphs, scaling graph, include accuracy graph)
%   \item Discuss Sim vs Real differences
%   \item Include graphical analysis of sim vs real graphs speed up, accuracy
%   \item Compare temporal vs spatial motion planner
%   \item Include racing graph analysis
% \end{enumerate}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{images/grouped_comparison.png}
